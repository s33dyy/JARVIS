...
const ConfirmationPopup = ({ request, onConfirm, onDeny }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in">
            <div className="relative w-full max-w-lg p-8 bg-black/90 border border-green-500/30 rounded-3xl shadow-[0_0_50px_rgba(74,222,128,0.15)] backdrop-blur-2xl transform transition-all scale-100">
                ...
                <div className="flex items-center gap-4 mb-6 relative z-10">
                    <div className="p-3 rounded-full bg-green-900/30 border border-green-500/50 text-green-400 shadow-[0_0_15px_rgba(74,222,128,0.2)]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                    </div>
                    <div>
                        <h2 className="text-xl font-bold text-green-400 tracking-wider font-mono drop-shadow-sm">
                ...
                <div className="mb-8 space-y-4 relative z-10">
                    ...
                    <div className="space-y-2">
                        <div className="bg-green-950/30 border border-green-800/50 rounded-xl overflow-hidden">
                            <div className="bg-green-900/40 px-4 py-2 border-b border-green-800/50 flex justify-between items-center">
                                <span className="text-xs text-green-400 font-bold uppercase tracking-wider">Function</span>
                        ...
                        <div className="bg-green-950/30 border border-green-800/50 rounded-xl overflow-hidden">
                            <div className="bg-green-900/40 px-4 py-2 border-b border-green-800/50 flex justify-between items-center">
                                <span className="text-xs text-green-400 font-bold uppercase tracking-wider">Parameters</span>
                ...
                <div className="flex gap-4 relative z-10">
                    ...
                    <button
                        onClick={onConfirm}
                        className="flex-1 px-4 py-3.5 rounded-xl border border-green-500/30 bg-green-950/40 text-green-400 hover:bg-green-900/60 hover:border-green-400 hover:text-green-300 transition-all duration-200 font-bold tracking-wider uppercase text-xs shadow-[0_0_20px_rgba(74,222,128,0.1)] hover:shadow-[0_0_30px_rgba(74,222,128,0.25)] relative overflow-hidden group"
                    >
