        ...
        >
            ...
            <div className="flex justify-center gap-6 relative z-10">
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all duration-300 ${!isConnected
                        ...
                        : isMuted
                            ...
                            : 'border-green-500 bg-green-500/10 text-green-500 hover:bg-green-500/20 shadow-[0_0_15px_rgba(22,163,74,0.3)]'
                        } `}
                >
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all ${showSettings ? 'border-green-400 text-green-400 bg-green-900/20' : 'border-green-900 text-green-700 hover:border-green-500 hover:text-green-500'
                        } `}
                >
                    <Settings size={24} />
                </button>
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all duration-300 ${showBrowserWindow
                        ...
                        : 'border-green-900 text-green-700 hover:border-blue-500 hover:text-blue-500'
                        } `}
                >
                    <Globe size={24} />
                </button>
